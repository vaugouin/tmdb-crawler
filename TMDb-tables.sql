...
CREATE TABLE `T_WC_TMDB_MOVIE` (
  ...
  `WIKIPEDIA_FORMAT_LINE_ORIGINAL` mediumtext DEFAULT NULL,
...
CREATE TABLE `T_WC_TMDB_MOVIE_LANG_META` (
  ...
  `TIM_UPDATED` datetime DEFAULT NULL,
  `ID_USER_UPDATED` int(5) DEFAULT NULL,
  `IS_COLOR` int(5) DEFAULT NULL,
  `IS_BW` int(5) DEFAULT NULL,
  `IS_SILENT` int(5) DEFAULT NULL,
  `IS_3D` int(5) DEFAULT NULL,
  `COLOR_TECHNOLOGY` varchar(50) DEFAULT NULL,
  `FILM_TECHNOLOGY` varchar(50) DEFAULT NULL,
  `ASPECT_RATIO` varchar(20) DEFAULT NULL,
  `FILM_FORMAT` varchar(20) DEFAULT NULL,
  `SOUND_SYSTEM` varchar(50) DEFAULT NULL,
  `NUM_AUDIO_TRACKS` int(5) DEFAULT NULL,
  `IS_VALID_FORMAT` int(5) DEFAULT NULL,
  `WIKIPEDIA_FORMAT_LINE` mediumtext DEFAULT NULL,
  `IS_MOVIE` int(5) DEFAULT NULL,
  `IS_DOCUMENTARY` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
